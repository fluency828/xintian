...
class Guanyun_mingyang_3200():
    ...
    pitch_motor_temp =  [
        ...
        # print(raw_data[['变流器转矩设定值']])
        print(self.generator_torque_pn,self.generator_speed_pn)
        ## 整理原始数据
